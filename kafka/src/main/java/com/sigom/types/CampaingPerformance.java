...
public class CampaingPerformance {
    ...
    public CampaingPerformance withCampaigner(String campaigner) {
        this.campaigner = campaigner;
        return this;
    }
    ...
    public CampaingPerformance withAdImpressions(Long adImpressions) {
        this.adImpressions = adImpressions;
        return this;
    }
    ...
    public CampaingPerformance withAdClicks(Long adClicks) {
        this.adClicks = adClicks;
        return this;
    }
